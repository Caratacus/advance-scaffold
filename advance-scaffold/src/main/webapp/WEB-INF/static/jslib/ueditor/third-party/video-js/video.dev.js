...
================================================================================ */
/**
 * The core functionality for sliders like the volume bar and seek bar
 *
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Run core component initializing with new options.
...
/**
 * The core class for all text tracks
 *
...
/**
 * The core class for buttons that toggle specific text track types (e.g. subtitles)
 *
 * @constructor
 */
