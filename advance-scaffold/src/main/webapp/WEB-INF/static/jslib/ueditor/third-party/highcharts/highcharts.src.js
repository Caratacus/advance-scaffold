...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the core lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the core lines for areas
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			destroy: function () {
				...
				// Call core implementation to destroy the rest
...
/**
 * The Point object and prototype. Inheritable and used as core for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The core function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the core Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call core method
	...
	/**
	 * Draw the graph and the underlying area. This method calls the Series core
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	groupPadding: 0.2,
	//grouping: true,
	marker: null, // point options are specified in the core options
	pointPadding: 0.1,
	//pointWidth: null,
	minPointLength: 0,
...
var PieSeries = {
	...
	/**
	 * Override the core drawDataLabels method by pie specific functionality
	 */
	drawDataLabels: function () {
		var series = this,
			data = series.data,
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the core method (#407)
