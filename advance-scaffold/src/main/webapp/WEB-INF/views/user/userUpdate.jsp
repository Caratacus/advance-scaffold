		...
		<form id="userEditForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					...
					<td>邮箱</td>
					<td><input type="text" name="email" class="easyui-numberbox" value="${user.email}"/></td>
				</tr>
				<tr>
					<td>用户状态</td>
					<td colspan="3"><select id="state" name="state" value="${user.state}" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
